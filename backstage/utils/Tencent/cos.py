...
from backstage.settings import TENCENT_SECRET_ID, TENCENT_SECRET_KEY
...
class TencentCos():
    ...
    def upload_file(self, local_file_name, file_name, region="ap-nanjing", bucket="siteimages-1311013567"):
        ...
        config = CosConfig(Region=region, SecretId=TENCENT_SECRET_ID, SecretKey=TENCENT_SECRET_KEY)
