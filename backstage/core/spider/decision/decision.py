...
from core.spider.crawl.dynamic import DynamicLocalSpiderCrawl
...
class UpdateCrawlScheduler(Scheduler):
    ...
    def executor(self):
        with DynamicLocalSpiderCrawl(self.params) as crawl:
            return crawl.spider()
...
class LocalCrawlScheduler(Scheduler):
    ...
    def executor(self):
        ...
        with LocalSpiderCrawl(self.params) as crawl:
            return crawl.spider()
